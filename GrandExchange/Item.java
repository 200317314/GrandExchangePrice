...
public class Item {
    ...
    public Item(int id, int sellingPrice, int buyAverage, int buyQuanity, int sellAverage, int sellQuanity, int overallAverage, int overallQuanity, String name, boolean members) {
        this.id = id;
